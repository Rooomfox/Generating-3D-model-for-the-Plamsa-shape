...
from threed_dda import threed_dda
...
# Calculate how many points in each cube.
cubes = {}
...
for line in lines:
    ...
    all_points += threed_dda(modified_points, scale)
...
def marching_cubes_3d_single_cell(cube, x, y, z):
    # Determine which case we are. Here the threshold is 0.1.
    case = sum(2**v for v in range(8) if cube[v] > 0.01)
